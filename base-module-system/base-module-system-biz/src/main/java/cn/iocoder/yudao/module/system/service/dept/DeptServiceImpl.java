...
public class DeptServiceImpl implements DeptService {
    ...
    @Override
    public List<DeptDO> getListByParentId(Long parentId) {
        LambdaQueryWrapper<DeptDO> wrapper = new LambdaQueryWrapper<>();
        wrapper = wrapper.eq(DeptDO::getStatus,0)
    ...
    public DeptDO getDeptByName(String name) {
        LambdaQueryWrapper<DeptDO> wrapper = new LambdaQueryWrapper<>();
        wrapper = wrapper.eq(DeptDO::getName,name);
    ...
    @Override
    public void updateDeptInfo(DeptDO updateReqVO) {
        if (updateReqVO.getId()==null){
            deptMapper.insert(updateReqVO);
        }else{
            deptMapper.updateById(updateReqVO);
        }
    }
