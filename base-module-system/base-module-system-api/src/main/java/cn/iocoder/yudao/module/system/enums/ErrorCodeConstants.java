...
public interface ErrorCodeConstants {
    ...
    // ========== 预约活动 TODO 补充编号 ==========
    ErrorCode APPOINT_ACTIVE_NOT_EXISTS = new ErrorCode(1_002_029_000, "预约活动不存在");
    // ========== 经销商 TODO 补充编号 ==========
    ErrorCode SUPPLIER_NOT_EXISTS = new ErrorCode(1_002_030_000, "经销商不存在");
    // ========== 经销商活动 TODO 补充编号 ==========
    ErrorCode SUPPLIER_ACTIVE_NOT_EXISTS = new ErrorCode(1_002_031_000, "经销商活动不存在");
    // ========== 量表管理 TODO 补充编号 ==========
    ErrorCode QUESTION_NOT_EXISTS = new ErrorCode(1_002_032_000, "量表管理不存在");
    // ========== 量表题目 TODO 补充编号 ==========
    ErrorCode QUESTION_TOPIC_NOT_EXISTS = new ErrorCode(1_002_033_000, "量表题目不存在");

    // ========== 每日预约 TODO 补充编号 ==========
    ErrorCode DAY_RESERVATION_NOT_EXISTS = new ErrorCode(1_002_034_000,"每日预约不存在");
    ErrorCode DAY_RESERVATION_DATE_EXISTS = new ErrorCode(1_002_034_001,"该预约日期已存在");
    // ========== 量表因子 TODO 补充编号 ==========
    ErrorCode QUESTION_FACTOR_NOT_EXISTS = new ErrorCode(1_002_035_000, "量表因子不存在");
    // ========== 量表维度 TODO 补充编号 ==========
    ErrorCode QUESTION_DIMENSION_NOT_EXISTS = new ErrorCode(1_002_036_000, "量表维度不存在");
}
