...
//        }
    ...
    @Override
    public Boolean existsPointRecord(LambdaQueryWrapper<MemberPointRecordDO> wrapper) {
        Boolean result = false;
        Long count = memberPointRecordMapper.selectCount(wrapper);
    ...
    @Override
    public Boolean existsPointRecord(Long userId, Integer bizType) {
        LambdaQueryWrapper<MemberPointRecordDO> wrapper = new LambdaQueryWrapper<>();
        wrapper = wrapper.eq(MemberPointRecordDO::getUserId,userId).eq(MemberPointRecordDO::getBizType,bizType);
        return existsPointRecord(wrapper);
    }
}
