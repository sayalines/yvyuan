...
// 获得成交数据分页
export const getDealTradePage = async (params) => {
  return await request.get({ url: `/statistics/trade/deal/page`, params })
}

// 导出成交数据
export const exportDealTradeExcel = async (params) => {
  return await request.download({ url: `/statistics/trade/deal/export-excel`, params })
}

// 获得交易明细分页
export const getDealDetailPage = async (params) => {
  return await request.get({ url: `/statistics/trade/deal/detail/page`, params })
}

// 导出交易明细
export const exportDealDetailExcel = async (params) => {
  return await request.download({ url: `/statistics/trade/deal/detail/export-excel`, params })
}

// 获得交易汇总分页
export const getDealTotalPage = async (params) => {
  return await request.get({ url: `/statistics/trade/deal/total/page`, params })
}

// 导出交易汇总
export const exportDealTotalExcel = async (params) => {
  return await request.download({ url: `/statistics/trade/deal/total/export-excel`, params })
}
