...
// 获得访客信息分页
export const getMemberVisitPage = async (params) => {
  return await request.get({ url: `/statistics/member/visit/page`, params })
}

// 导出访客信息
export const exportMemberVisitExcel = async (params) => {
  return await request.download({ url: `/statistics/member/visit/export-excel`, params })
}

// 获得访客行为分页
export const getMemberActionPage = async (params) => {
  return await request.get({ url: `/statistics/member/action/page`, params })
}

// 导出访客行为
export const exportMemberActionExcel = async (params) => {
  return await request.download({ url: `/statistics/member/action/export-excel`, params })
}
