...
export interface UserVO {
  ...
  rainbow: number | undefined | null
  totalRainbow: number | undefined | null
  experience: number | null | undefined
  isRegister: boolean
  isTakeNewGiftPack: boolean
  idCode: string | undefined
  idCodeType: number | undefined
...
// 修改会员用户彩虹值
export const updateUserRainbow = async (data: any) => {
  return await request.put({ url: `/member/user/update-rainbow`, data })
}
