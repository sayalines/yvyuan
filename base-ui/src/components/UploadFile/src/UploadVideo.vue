<template>
  <div class="upload-file">
    ...
    >
      <el-button type="primary"><Icon icon="ep:upload-filled" />选取视频</el-button>
...
const props = defineProps({
  ...
  title: propTypes.string.def('视频上传'),
  updateUrl: propTypes.string.def(import.meta.env.VITE_UPLOAD_URL),
  fileType: propTypes.array.def(['mp4']), // 视频类型, 例如['png', 'jpg', 'jpeg']
