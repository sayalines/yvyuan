...
<!--        </el-button>-->
  ...
  <ContentWrap>
    ...
    >
      ...
      <el-table-column prop="name" label="部门名称" width="300px" />
      <el-table-column prop="leader" label="负责人" width="120px">
        <template #default="scope">
          {{ userList.find((user) => user.id === scope.row.leaderUserId)?.nickname }}
        </template>
      </el-table-column>
      <el-table-column prop="areaName" label="所在区" width="150px" />
      <el-table-column prop="parentId" label="上级部门ID" width="100px" />
