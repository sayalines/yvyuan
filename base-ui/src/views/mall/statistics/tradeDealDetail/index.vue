    ...
    >
      ...
      <el-form-item>
        ...
        <el-button
          ...
          v-hasPermi="['statistics:tradeDetail:export']"
        >
...
<!--      <el-table-column label="unionid" align="center" prop="unionid" />-->
      ...
      <el-table-column label="商品名称" align="center" prop="spuName"  width="250"/>
      <el-table-column label="规格名称" align="center" prop="skuName" />
      <el-table-column label="数量" align="center" prop="count" />
      <el-table-column label="支付金额" align="center" prop="payPrice" />
      <el-table-column label="原单金额" align="center" prop="sourcePrice" />
...
defineOptions({ name: 'TradeDelDetailStatistics' })
...
const getList = async () => {
  loading.value = true
  try {
    const data = await TradeStatisticsApi.getDealDetailPage(queryParams)
...
const handleExport = async () => {
  try {
    ...
    const data = await TradeStatisticsApi.exportDealDetailExcel(queryParams)
    download.excel(data, '交易明细.xls')
  } catch {
  } finally {
