  ...
  <ContentWrap>
    ...
    <el-descriptions title="订单信息">
      ...
      <el-descriptions-item label="是否支付: ">
        <dict-tag :type="DICT_TYPE.INFRA_BOOLEAN_STRING" :value="formData.payStatus!" />
      </el-descriptions-item>
      <el-descriptions-item label="支付时间: ">{{ formatDate(formData.payTime) }}</el-descriptions-item>
      <el-descriptions-item label="赠送积分: ">{{ formData.givePoint }}</el-descriptions-item>
<!--      <el-descriptions-item label="兑换码: ">{{ formData.exchangeCode}}</el-descriptions-item>-->
...
<!--      </el-descriptions-item>-->
      <el-descriptions-item label="配送方式: ">{{ formData?.deliveryExpressTemplate?.name }}</el-descriptions-item>
