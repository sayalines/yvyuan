<template>
  <Dialog :title="dialogTitle" v-model="dialogVisible">
    ...
    >
      ...
      <el-form-item label="分类ID" prop="id" v-if="formData.id">
        <el-input v-model="formData.id" disabled placeholder="请输入分类ID" />
      </el-form-item>
...
import {getCategoryTree} from "@/api/mall/product/category";
...
const open = async (type: string, id?: number) => {
  ...
  // 获得分类树
  categoryTree.value = []
  const data = await ProductCategoryApi.getCategoryTree(queryParam)
