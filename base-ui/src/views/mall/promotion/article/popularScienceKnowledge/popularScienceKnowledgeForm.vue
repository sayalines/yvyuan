  ...
  <Dialog v-model="dialogVisible" :title="dialogTitle" width="70%">
    ...
    >
      <el-row>
        ...
        <el-col :span="12">
          <el-form-item label="是否列表展示" prop="ifExhibition">
...
defineOptions({ name: 'promotionPopularScienceKnowledgeForm' })
...
const formRules = reactive({
  ...
  ifExhibition: [{required: true, message: '是否列表展示不能为空', trigger: 'blur'}],
