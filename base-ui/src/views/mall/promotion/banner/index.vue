<template>
  ...
  <ContentWrap>
    <el-table v-loading="loading" :data="list" :show-overflow-tooltip="true" :stripe="true">
      ...
      <el-table-column align="center" label="标题" prop="title" width="200px" />
      <el-table-column align="center" label="图片" min-width="100" prop="picUrl">
        <template #default="{ row }">
          <el-image :src="row.picUrl" class="w-80px" @click="imagePreview(row.picUrl)" />
        </template>
      </el-table-column>
<!--      <el-table-column align="center" label="WAP图片" min-width="100" prop="wapPicUrl">-->
<!--        <template #default="{ row }">-->
<!--          <el-image :src="row.wapPicUrl" class="w-80px" @click="imagePreview(row.wapPicUrl)" />-->
<!--        </template>-->
<!--      </el-table-column>-->
      ...
      <el-table-column align="center" label="定位" prop="position" width="120px">
        <template #default="scope">
