<template>
  ...
  <ContentWrap>
    <el-table v-loading="loading" :data="list" :stripe="true" :show-overflow-tooltip="true">
      ...
      <el-table-column label="等级图标"  prop="backgroundUrl"  width="100">
        <template #default="{ row }">
          <el-image :src="row.icon" class="h-40px w-60px" @click="imagePreview(row.icon)" />
        </template>
      </el-table-column>
      <el-table-column label="等级背景图"  prop="backgroundUrl"  width="100">
        <template #default="{ row }">
          <el-image :src="row.backgroundUrl" class="h-40px w-60px" @click="imagePreview(row.backgroundUrl)" />
        </template>
      </el-table-column>
