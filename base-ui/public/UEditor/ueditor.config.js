...
(function () {
  ...
  window.UEDITOR_CONFIG = {
    ...
    , whitList: {
      ...
      header: [],
      hr: [],
      i: ['class', 'style','data-v-37cfbb3c','data-src'],
      ...
      u: [],
      ul: ['class', 'style'],
      video: ['poster', 'autoplay', 'controls', 'loop', 'preload', 'src', 'height', 'width', 'class', 'style', 'poster', 'onclick','id','x-webkit-airplay','x5-video-player-type','x5-video-player-fullscreen','webkit-playsinline','playsinline'],
      source: ['src', 'type'],
