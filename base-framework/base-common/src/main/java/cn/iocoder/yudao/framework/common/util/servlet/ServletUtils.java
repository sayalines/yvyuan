...
public class ServletUtils {
    ...
    public static String getBrowser(String userAgentStr) {
        ...
        if(ObjectUtil.isNotNull(userAgent)){
            if(ObjectUtil.isNotNull(userAgent.getBrowser())){
                info.add("Browser: " + userAgent.getBrowser().getName());
            }
            if(StrUtil.isNotBlank(userAgent.getVersion())){
                info.add("Version: " + userAgent.getVersion());
            }
            if(ObjectUtil.isNotNull(userAgent.getPlatform())){
                info.add("Platform: " + userAgent.getPlatform().getName());
            }
        }
