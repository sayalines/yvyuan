...
public interface ProductSpuMapper extends BaseMapperX<ProductSpuDO> {
    ...
    default PageResult<ProductSpuDO> selectPage(ProductSpuPageReqVO reqVO) {
        ...
        LambdaQueryWrapperX<ProductSpuDO> queryWrapper = new LambdaQueryWrapperX<ProductSpuDO>()
                ...
                .eqIfPresent(ProductSpuDO::getIsFirstProduct, reqVO.getIsFirstProduct())
    ...
    default PageResult<ProductSpuDO> selectPage(AppProductSpuPageReqVO pageReqVO, Set<Long> categoryIds) {
        LambdaQueryWrapperX<ProductSpuDO> query = new LambdaQueryWrapperX<ProductSpuDO>()
                .eqIfPresent(ProductSpuDO::getIsFirstProduct, pageReqVO.getIsFirstProduct())
                // 关键字匹配，目前只匹配商品名
        ...
        } else if (Objects.equals(pageReqVO.getSortField(), AppProductSpuPageReqVO.RECOMMEND_TYPE_HOT)) {
            query.orderByDesc(ProductSpuDO::getRecommendHot).orderByDesc(ProductSpuDO::getId);
        }  else {
    ...
    List<ProductUnionVo> findUnionProduct(@Param("startIndex") Integer startIndex, @Param("pageSize") Integer pageSize, @Param("keyword") String keyword,@Param("isFirstProduct") Boolean isFirstProduct);

    Long findUnionProductCount(@Param("keyword") String keyword,@Param("isFirstProduct") Boolean isFirstProduct);

    Long getSkuOrderItemCount(@Param("skuId") Long skuId);
