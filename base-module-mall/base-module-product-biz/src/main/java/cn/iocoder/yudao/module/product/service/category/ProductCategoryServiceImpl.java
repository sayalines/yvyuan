...
//        }
    ...
    @Override
    public List<ProductCategoryDO> getEnableCategoryList(List<Long> parentIds) {
        LambdaQueryWrapper<ProductCategoryDO> wrapper = new LambdaQueryWrapper<>();
        wrapper = wrapper.eq(ProductCategoryDO::getStatus,CommonStatusEnum.ENABLE.getStatus())
    ...
    public List<ProductCategoryDO> getEnableCategoryList(ProductCategoryListReqVO listReqVO) {
        listReqVO.setStatus(CommonStatusEnum.ENABLE.getStatus());
