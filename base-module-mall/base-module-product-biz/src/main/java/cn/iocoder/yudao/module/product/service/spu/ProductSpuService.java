...
public interface ProductSpuService {
    ...
    /**
     * 获得联合产品 分页，提供给用户 App 使用
     *
     * @return 商品 SPU 分页
     */
    PageResult<ProductUnionVo> getUnionProductPage(Integer pageNo,Integer pageSize,String keyword,Boolean isFirstProduct);
     ...
     * @param updateReqVO 更新信息
     */
    void updateSpu(ProductSpuDO updateReqVO);

    /**
     * 删除规格前校验
     * @param id
     */
    void validSkuBeforeDelete(Long id);
