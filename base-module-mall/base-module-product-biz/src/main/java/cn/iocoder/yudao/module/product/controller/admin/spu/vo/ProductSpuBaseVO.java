...
public class ProductSpuBaseVO {
    ...
    @Schema(description = "赠送礼品")
    private Long giveGift;

    @Schema(description = "是否限时购买")
    private Boolean isLimitTime;

    @Schema(description = "限时开始时间")
    private LocalDateTime limitTimeStart;

    @Schema(description = "限时结束时间")
    private LocalDateTime limitTimeEnd;

    @Schema(description = "限购数量", example = "1")
    private Integer limitCount;

    @Schema(description = "是否首单优惠商品")
