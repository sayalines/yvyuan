...
public class TradePriceServiceImpl implements TradePriceService {
    ...
    private List<ProductSpuRespDTO> getSpuList(List<ProductSkuRespDTO> skuList) {
        // 获得商品 SPU 数组
        return productSpuApi.getSpuList(convertSet(skuList, ProductSkuRespDTO::getSpuId));
    }
