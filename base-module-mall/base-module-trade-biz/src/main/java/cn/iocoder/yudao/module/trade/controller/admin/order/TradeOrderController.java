...
public class TradeOrderController {
    ...
    public CommonResult<TradeOrderDetailRespVO> getOrderDetail(@RequestParam("id") Long id) {
        ...
        if (respVO.getDeliveryTemplateId()!=null){
            respVO.setDeliveryExpressTemplate(deliveryExpressTemplateService.getDeliveryExpressTemplateData(respVO.getDeliveryTemplateId()));
        }
    ...
    public CommonResult<Boolean> deliveryOrder(@RequestBody TradeOrderDeliveryReqVO deliveryReqVO) {
        if (deliveryReqVO.getLogisticsId()!=null){
            DeliveryExpressDO deliveryExpressDO = deliveryExpressService.getDeliveryExpress(deliveryReqVO.getLogisticsId());
            if (deliveryExpressDO!=null){
                deliveryReqVO.setDeliveryName(deliveryExpressDO.getName());
            }
        }
    ...
    @PreAuthorize("@ss.hasPermission('trade:order:update')")
    public CommonResult<Boolean> refundOrder(@RequestBody TradeRefundOrderReqVO reqVO) {
        tradeOrderUpdateService.refundOrder(reqVO.getId(),reqVO.getRefundPrice(),reqVO.getReason());
        return success(true);
    }
