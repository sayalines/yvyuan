...
public interface TradeOrderUpdateService {
     ...
     * @param order         交易订单
     */
    void updateZeroOrderPaid(TradeOrderDO order);
     ...
     * @param reason
     */
    void refundOrder(Long id,Integer refundPrice,String reason);
     ...
     * payOrderId 支付编号
     */
    void refundOrder(Long payOrderId);
