...
public interface CouponService {
     ...
     * @param takeType   领取方式
     */
    CouponDO takeCoupon(Long templateId, Long userId, CouponTakeTypeEnum takeType);
     ...
     * @param takeType   领取方式
     */
    Long takeCoupon(Long templateId, Long userId,String exchangeCode, CouponTakeTypeEnum takeType);
     ...
     * @param takeType   领取方式
     */
    Long takeCoupon(Long templateId, Long userId,Long activityId, CouponTakeTypeEnum takeType);
