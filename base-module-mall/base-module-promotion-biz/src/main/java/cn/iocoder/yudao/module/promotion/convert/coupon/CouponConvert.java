...
public interface CouponConvert {
    ...
    default CouponDO convert(CouponTemplateDO template, Long userId,String exchangeCode) {
        CouponDO couponDO = convert(template,userId);
        couponDO.setExchangeCode(exchangeCode);
        return couponDO;
    }

    default CouponDO convert(CouponTemplateDO template, Long userId,Long activityId) {
        CouponDO couponDO = convert(template,userId);
