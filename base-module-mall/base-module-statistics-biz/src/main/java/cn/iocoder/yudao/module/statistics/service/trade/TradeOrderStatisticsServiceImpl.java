...
public class TradeOrderStatisticsServiceImpl implements TradeOrderStatisticsService {
    ...
    @Override
    public Long selectCountByStatusAndDeliveryTypeByCommon(Integer status, Integer deliveryType) {
        return tradeOrderStatisticsMapper.selectCountByStatusAndDeliveryTypeByCommon(status, deliveryType);
    }
    ...
    private TradeOrderSummaryRespVO getPayPriceSummary(LocalDateTime date) {
        ...
        return tradeOrderStatisticsMapper.selectPaySummaryByStatusAndPayTimeBetween(beginTime, endTime);
    }
