...
public interface TradeOrderStatisticsMapper extends BaseMapperX<TradeStatisticsDO> {
    ...
    // TODO 芋艿：已经 review
    TradeOrderSummaryRespVO selectPaySummaryByStatusAndPayTimeBetween(@Param("beginTime") LocalDateTime beginTime,
                                                                      @Param("endTime") LocalDateTime endTime);
     ...
     * @return
     */
    Long selectCountByStatusAndDeliveryTypeByCommon(@Param("status") Integer status, @Param("deliveryType") Integer deliveryType);
