...
public interface ErrorCodeConstants {
    ...
    ErrorCode ARTICLE_CATEGORY_EXITS_CHILDREN = new ErrorCode(1_013_015_001, "存在存在子文章分类，无法删除");
    ErrorCode ARTICLE_CATEGORY_PARENT_NOT_EXITS = new ErrorCode(1_013_015_002,"父级文章分类不存在");
    ErrorCode ARTICLE_CATEGORY_PARENT_ERROR = new ErrorCode(1_013_015_003, "不能设置自己为父文章分类");
    ErrorCode ARTICLE_CATEGORY_NAME_DUPLICATE = new ErrorCode(1_013_015_004, "已经存在该名称的文章分类");
    ErrorCode ARTICLE_CATEGORY_PARENT_IS_CHILD = new ErrorCode(1_013_015_005, "不能设置自己的子ArticleCategory为父ArticleCategory");
    ErrorCode ARTICLE_CATEGORY_DELETE_FAIL_HAVE_ARTICLES = new ErrorCode(1_013_015_006, "文章分类删除失败，存在关联文章");
