...
public interface ErrorCodeConstants {
    ...
    ErrorCode ORDER_NOT_ZERO = new ErrorCode(1_011_000_051, "该订单不是零支付单");
    ...
    ErrorCode ORDER_REFUND_ORDER_STATUS_NO_PAID = new ErrorCode(1_011_011_101, "订单未支付，无法退款");
    ErrorCode ORDER_REFUND_ORDER_STATUS_CANCEL = new ErrorCode(1_011_011_102, "订单已取消，无法退款");
    ErrorCode ORDER_REFUND_ORDER_STATUS_REFUND = new ErrorCode(1_011_011_102, "订单已退款，无法退款");
    ErrorCode ORDER_REFUND_PAY_ORDER_NO_FOUND = new ErrorCode(1_011_011_103, "支付单找不到，无法退款");
    ErrorCode ORDER_REFUND_PARAM_ERROR = new ErrorCode(1_011_011_104, "参数错误，无法退款");
    ErrorCode ORDER_REFUND_AMOUNT_ZERO = new ErrorCode(1_011_011_105, "退款金额必须大于等于0，无法退款");
    ErrorCode ORDER_REFUND_AMOUNT_ERROR = new ErrorCode(1_011_011_105, "退款金额必须小于等于支付金额，无法退款");
}
