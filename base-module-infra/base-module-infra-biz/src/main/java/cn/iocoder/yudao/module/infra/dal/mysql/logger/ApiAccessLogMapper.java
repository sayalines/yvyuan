...
public interface ApiAccessLogMapper extends BaseMapperX<ApiAccessLogDO> {
    ...
    default PageResult<ApiAccessLogDO> selectPage(ApiAccessLogPageReqVO reqVO) {
        return selectPage(reqVO, new LambdaQueryWrapperX<ApiAccessLogDO>()
                ...
                .eqIfPresent(ApiAccessLogDO::getType, reqVO.getType())
                .likeIfPresent(ApiAccessLogDO::getGroupName, reqVO.getGroupName())
                .likeIfPresent(ApiAccessLogDO::getTitle, reqVO.getTitle())
                .eqIfPresent(ApiAccessLogDO::getMobileModel, reqVO.getMobileModel())
     ...
     * @return 删除条数
     */
    @Delete("DELETE FROM infra_api_access_log WHERE begin_time < #{createTime} LIMIT #{limit}")
