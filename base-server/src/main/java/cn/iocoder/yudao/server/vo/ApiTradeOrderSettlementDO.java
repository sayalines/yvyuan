...
@Data
public class ApiTradeOrderSettlementDO {
    ...
    public static class Item {
        ...
        @Schema(description = "SKU 名字", requiredMode = Schema.RequiredMode.REQUIRED, example = "Apple iPhone 12")
        ...
        // ========== 赠品信息 ==========
        @Schema(description = "赠品ID", requiredMode = Schema.RequiredMode.REQUIRED, example = "100")
        private Long giftId;
        @Schema(description = "赠品名字")
        private String giftName;
        @Schema(description = "赠品图片地址")
    ...
    public static class Price {
        ...
        @Schema(description = "商品原价（总）", requiredMode = Schema.RequiredMode.REQUIRED, example = "500")
        private BigDecimal totalPrice;

        @Schema(description = "订单优惠（总）", requiredMode = Schema.RequiredMode.REQUIRED, example = "66")
        private BigDecimal discountPrice;

        @Schema(description = "运费金额", requiredMode = Schema.RequiredMode.REQUIRED, example = "50")
        private BigDecimal deliveryPrice;

        @Schema(description = "优惠劵减免金额", requiredMode = Schema.RequiredMode.REQUIRED, example = "100")
        private BigDecimal couponPrice;

        @Schema(description = "积分抵扣的金额", requiredMode = Schema.RequiredMode.REQUIRED, example = "50")
        private BigDecimal pointPrice;

        @Schema(description = "VIP 减免金额", requiredMode = Schema.RequiredMode.REQUIRED, example = "30")
        private BigDecimal vipPrice;

        @Schema(description = "实际支付金额（总）", requiredMode = Schema.RequiredMode.REQUIRED, example = "450")
