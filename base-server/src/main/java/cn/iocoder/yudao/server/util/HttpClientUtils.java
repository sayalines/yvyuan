...
public class HttpClientUtils {
	...
	public static String getByToken(String url, String token) {
		...
		return executeRequest(httpGet,  UTF_8);
	}
	...
	public static String ajaxPost(String url, Map<String, String> dataMap) {
		return ajaxPost(url, dataMap, UTF_8);
	}
	...
	public static String ajaxPostJson(String url, String jsonString) {
		return ajaxPostJson(url, jsonString, UTF_8);
	}
...
//		}
	...
	public static String executeRequest(HttpUriRequest httpRequest) {
		return executeRequest(httpRequest, UTF_8);
	}
